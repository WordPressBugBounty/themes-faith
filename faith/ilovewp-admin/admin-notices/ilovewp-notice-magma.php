...
class faith_notice_magma extends faith_notice {
	...
	public function magma_notice_markup() {
		...
		$dismiss_url = wp_nonce_url(
			remove_query_arg( array( 'activated' ), add_query_arg( 'faith-hide-notice', 'magma-user-' . $this->current_user_id ) ),
		...
		if ( ( get_option( 'faith_theme_installed_time' ) > strtotime( '-3 days' ) ) ) {
			return;
		}
				...
				--><div class="ilovewp-message-text">
					...
					<p>
						...
						printf(
							...
							'<a href="' . esc_url( admin_url( 'themes.php?page=faith-doc' ) ) . '">' . esc_html( $theme_data->Name ) . ' Theme</a>',
							'<br>',
							'<strong><a href="https://www.ilovewp.com/product/magma/?utm_source=dashboard&utm_medium=magma-notice&utm_campaign=faith&utm_content=magma-notice">Magma</a></strong>');
						?>
					</p>

					<p class="notice-buttons"><a href="https://www.ilovewp.com/product/magma/?utm_source=dashboard&utm_medium=magma-notice&utm_campaign=faith&utm_content=magma-notice" class="btn button button-primary ilovewp-button" target="_blank"><?php esc_html_e( 'Discover Magma today!', 'faith' ); ?></a> <a href="https://www.youtube.com/watch?v=pxNKBXG4clY" target="_blank" rel="noopener" class="button button-primary ilovewp-button ilovewp-button-youtube"><span class="dashicons dashicons-youtube"></span> <?php esc_html_e( 'Magma Video Guide', 'faith' ); ?></a></p>
