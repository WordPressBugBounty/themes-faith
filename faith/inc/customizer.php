	...
	return apply_filters( 'faith_color_schemes', array(
		'default' => array(
			...
			'colors' => array(
				...
				'#f2f0e4', // [2] header background color 
				'#1e74a9', // [3] link color
				'#C94913', // [4] link :hover color
				'#181818', // [5] main text color
				'#484848', // [6] secondary text color
				'#182122', // [7] footer background color
				'#C94913', // [8] accent background color
				'#cccccc', // [9] footer text color
			),
		),
	) );
}
...
function faith_header_background_color_css() {
	...
	$css = '
		...
		:root {
			--faith-special-background-color: %1$s;
		}';
...
function faith_footer_background_color_css() {
	...
	$css = '
		...
		:root {
			--faith-footer-background-color: %1$s;
		}';
...
function faith_highlight_background_color_css() {
	...
	$css = '
		/* Custom Accent Color */
		:root {
			--faith-primary-accent-color: %1$s;
		}';
...
function faith_secondary_text_color_css() {
	...
	$css = '
		...
		:root {
			--faith-secondary-text-color: %1$s;
		}';
